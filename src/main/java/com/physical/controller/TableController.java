...
public class TableController {
	...
	public ApiResult selectAll(@RequestBody Tableinfo table,HttpServletRequest request) {
		try {
			PageInfo pageinfo = PageInfoHelper.pageInit(table);
			table.setStartNums(pageinfo.getStartNums());
